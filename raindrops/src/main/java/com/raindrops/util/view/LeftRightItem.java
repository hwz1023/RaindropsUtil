...
public class LeftRightItem extends RelativeLayout {
    ...
    public LeftRightItem(Context context, AttributeSet attrs) {
        ...
        int leftWidth = (int) style.getDimension(R.styleable.raindropsCommonItem_raindrops_item_left_width, 0);
        int rightWidth = (int) style.getDimension(R.styleable.raindropsCommonItem_raindrops_item_right_width, 0);
        ...
        leftTv.setId(style.getResourceId(R.styleable.raindropsCommonItem_raindrops_item_left_id,
                R.id.item_left));
        ...
        rightTv.setId(style.getResourceId(R.styleable.raindropsCommonItem_raindrops_item_right_id,
                R.id.item_right));
        ...
        leftTv.setText(style.getText(R.styleable.raindropsCommonItem_raindrops_item_left_text));
        leftTv.setTextColor(style.getColor(R.styleable.raindropsCommonItem_raindrops_item_left_text_color, 0xff3B3B3B));

        leftTv.setTextSize(DensityUtils.px2sp(
                style.getDimension(R.styleable.raindropsCommonItem_raindrops_item_left_text_size, 15)));

        rightTv.setText(style.getText(R.styleable.raindropsCommonItem_raindrops_item_right_text));
        rightTv.setTextColor(style.getColor(R.styleable.raindropsCommonItem_raindrops_item_right_text_color, 0xff848484));
        rightTv.setTextSize(DensityUtils.px2sp(style.getDimension(
                R.styleable.raindropsCommonItem_raindrops_item_right_text_size, DensityUtils.sp2px(15f))));
        rightTv.setHintTextColor(style.getColor(R.styleable.raindropsCommonItem_raindrops_item_right_hint_color,
                0xff848484));
        rightTv.setHint(style.getString(R.styleable.raindropsCommonItem_raindrops_item_right_hint));

        boolean rightCanEdit = style.getBoolean(R.styleable.raindropsCommonItem_raindrops_item_right_can_edit, false);
